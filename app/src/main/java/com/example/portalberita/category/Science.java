...
public class Science extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(Science.this, list);
        ...
        api.getListNews("id", category, API_KEY).enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful()){
                    ...
                    news.setAdapter(new Adapter(Science.this, list));
                    adapter.notifyDataSetChanged();
                } else {
                    hideDialog();
                    Toast.makeText(Science.this, "Gagal mendapatkan data!", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<News> call, Throwable t) {
                hideDialog();
                Toast.makeText(Science.this, "Gagal terhubung ke internet!", Toast.LENGTH_SHORT).show();
            }
        });
    }
