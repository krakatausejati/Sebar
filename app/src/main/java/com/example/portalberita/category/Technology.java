...
public class Technology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(Technology.this, list);
        ...
        api.getListNews("id", category, API_KEY).enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful()){
                    ...
                    news.setAdapter(new Adapter(Technology.this, list));
                    adapter.notifyDataSetChanged();
                } else {
                    hideDialog();
                    Toast.makeText(Technology.this, "Gagal mendapatkan data!", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<News> call, Throwable t) {
                hideDialog();
                Toast.makeText(Technology.this, "Gagal terhubung ke internet!", Toast.LENGTH_SHORT).show();
            }
        });
    }
