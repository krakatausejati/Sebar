...
public class Health extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(Health.this, list);
        ...
        api.getListNews("id", category, API_KEY).enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful()){
                    ...
                    news.setAdapter(new Adapter(Health.this, list));
                    adapter.notifyDataSetChanged();
                } else {
                    hideDialog();
                    Toast.makeText(Health.this, "Gagal mendapatkan data!", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<News> call, Throwable t) {
                hideDialog();
                Toast.makeText(Health.this, "Gagal terhubung ke internet!", Toast.LENGTH_SHORT).show();
            }
        });
    }
